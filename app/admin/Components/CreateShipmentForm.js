'use client';
import { createNewShipment, fetchTrackingNumber } from '@/app/api/supabaseapi';
...
function CreateShipmentForm({
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const results = await updateStatusShipment(data);
    ...
    console.log(successMessage); // Now this will print after `setSuccessMessage` has been updated
