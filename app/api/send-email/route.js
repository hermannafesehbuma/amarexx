...
export async function POST(req) {
  try {
    ...
    const mailOptions = {
      from: email, // The user's email address (provided in the contact form)
      to: process.env.TITAN_SMTP_USER, // Your email address (Titan email where you want to receive submissions)
