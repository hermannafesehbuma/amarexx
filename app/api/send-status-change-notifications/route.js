        ...
        <html lang="en">
          ...
          <body>
            <div class="email-container">
              ...
              <p>We are pleased to inform you that the status of your shipment with tracking number <span class="highlight">${shipmentData.trackingNumber}</span> has been updated.</p>
    
              <div class="status-update">
                <p><strong>Current Status:</strong> ${shipmentData.status_id.status}</p>
              </div>
