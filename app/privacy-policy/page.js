...
function page() {
  ...
  const privacyData = [
    ...
    },
    {
      ...
      title2: '',
      description2: 'Please contact us at contact@amarexexpress.com',
    },
  ];
  ...
  return (
    <>
      <div className="md:w-[80%] xs:w-[98%] mx-auto mt-[7%] pt-[10vh] ">
        ...
        <p>
          This statement applies to Amarex customers and Amarex.com visitors,
      ...
      <div className="w-[80%] mx-auto mt-[7%] pb-[10vh]">
        ...
        <ul className="m-2 list-disc">
          <li>
            We use your information to provide you Amarex products and services,
          ...
          <li>
            ...
            financial transaction issues; to a Amarex auditor; to entities,
